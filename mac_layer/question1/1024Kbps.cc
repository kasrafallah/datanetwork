...
csma.EnableAsciiAll (ascii.CreateFileStream ("1024Kbps.tr"));
csma.EnablePcapAll ("16Kbps", false);

  AnimationInterface anim("1024Kbps.xml");
  ...
  plotHelper.ConfigurePlot ("HW3_Part1_Image","NonePersistent_CSMA","Time(second)","Packet Byte Count");
